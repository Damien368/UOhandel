    ...
    public class SBMage : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo(typeof(ArcaneFocus).GetConstructor(3600, 6), 500, 20, 0x3154, 0, false)) ;
                //Add(new GenericBuyInfo("Arcane Focus: 1 Hour", typeof(ArcaneFocus), 500, 20, 0x3155, 0, (3600,6 ), false));
